...
public ref partial struct Utf8JsonReader
{
    ...
    private readonly bool UnescapeAndCompare(ReadOnlySpan<byte> other)
    {
        ...
        if (localSpan.Length < other.Length ||
    ...
    private readonly bool UnescapeSequenceAndCompare(ReadOnlySpan<byte> other)
    {
        ...
        if (sequenceLength < other.Length ||
    ...
    private void EndObject()
    {
        if (!_inObject || _bitStack.CurrentDepth <= 0)
            ThrowHelper.ThrowJsonReaderException(ref this, ExceptionResource.MismatchedObjectArray,
    ...
    private bool ValidateHexDigits(ReadOnlySpan<byte> data, int idx)
    {
        for (int j = idx; j < data.Length; j++)
        {
            ...
            {
                ThrowHelper.ThrowJsonReaderException(ref this, ExceptionResource.InvalidHexCharacterWithinString,
                    nextByte);
            }
    ...
    private bool SkipComment()
    {
        ...
        if (localBuffer.Length > 0)
        {
            ...
            {
                ThrowHelper.ThrowJsonReaderException(ref this, ExceptionResource.ExpectedStartOfValueNotFound,
                    JsonConstants.Slash);
            }
        }
    ...
    private bool ConsumeComment()
    {
        ...
        if (localBuffer.Length > 0)
        {
            ...
            {
                ThrowHelper.ThrowJsonReaderException(ref this, ExceptionResource.InvalidCharacterAtStartOfComment,
                    marker);
            }
        }
