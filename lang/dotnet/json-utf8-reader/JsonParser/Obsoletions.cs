...
internal static class Obsoletions
{
    ...
    internal const string SystemTextEncodingUTF7Message =
    ...
    internal const string PrincipalPermissionAttributeMessage =
    ...
    internal const string CodeAccessSecurityMessage =
        "Code Access Security is not supported or honored by the runtime.";

    internal const string CodeAccessSecurityDiagId = "SYSLIB0003";

    internal const string ConstrainedExecutionRegionMessage =
    ...
    internal const string ThreadAbortMessage =
        "Thread.Abort is not supported and throws PlatformNotSupportedException.";

    internal const string ThreadResetAbortMessage =
    ...
    internal const string DefaultCryptoAlgorithmsMessage =
        "The default implementation of this cryptography algorithm is not supported.";

    internal const string DefaultCryptoAlgorithmsDiagId = "SYSLIB0007";

    internal const string CreatePdbGeneratorMessage =
    ...
    internal const string AuthenticationManagerMessage =
        "The AuthenticationManager Authenticate and PreAuthenticate methods are not supported and throw PlatformNotSupportedException.";

    internal const string AuthenticationManagerDiagId = "SYSLIB0009";

    internal const string RemotingApisMessage =
    ...
    internal const string BinaryFormatterMessage =
        "BinaryFormatter serialization is obsolete and should not be used. See https://aka.ms/binaryformatter for more information.";

    internal const string BinaryFormatterDiagId = "SYSLIB0011";

    internal const string CodeBaseMessage =
    ...
    internal const string EscapeUriStringMessage =
    ...
    internal const string WebRequestMessage =
        "WebRequest, HttpWebRequest, ServicePoint, and WebClient are obsolete. Use HttpClient instead.";

    internal const string WebRequestDiagId = "SYSLIB0014";

    internal const string DisablePrivateReflectionAttributeMessage =
    ...
    internal const string GetContextInfoMessage =
    ...
    internal const string StrongNameKeyPairMessage =
    ...
    internal const string ReflectionOnlyLoadingMessage =
        "ReflectionOnly loading is not supported and throws PlatformNotSupportedException.";

    internal const string ReflectionOnlyLoadingDiagId = "SYSLIB0018";

    internal const string RuntimeEnvironmentMessage =
    ...
    internal const string DerivedCryptographicTypesMessage =
    ...
    internal const string RNGCryptoServiceProviderMessage =
    ...
    internal const string AppDomainCreateUnloadMessage =
    ...
    internal const string X509CertificateImmutableMessage =
        "X509Certificate and X509Certificate2 are immutable. Use the appropriate constructor to create a new certificate.";

    internal const string X509CertificateImmutableDiagId = "SYSLIB0026";

    internal const string PublicKeyPropertyMessage =
    ...
    internal const string X509CertificatePrivateKeyMessage =
    ...
    internal const string ProduceLegacyHmacValuesMessage =
    ...
    internal const string UseManagedSha1Message =
    ...
    internal const string CryptoConfigEncodeOIDMessage =
    ...
    internal const string CorruptedStateRecoveryMessage =
    ...
    internal const string Rfc2898CryptDeriveKeyMessage =
    ...
    internal const string CmsSignerCspParamsCtorMessage =
    ...
    internal const string SignerInfoCounterSigMessage =
    ...
    internal const string RegexCompileToAssemblyMessage =
    ...
    internal const string AssemblyNameMembersMessage =
    ...
    internal const string SystemDataSerializationFormatBinaryMessage =
    ...
    internal const string TlsVersion10and11Message =
    ...
    internal const string EncryptionPolicyMessage =
    ...
    internal const string Rfc2898OutdatedCtorMessage =
    ...
    internal const string EccXmlExportImportMessage =
    ...
    internal const string EcDhPublicKeyBlobMessage =
    ...
    internal const string AssemblyNameCodeBaseMessage =
    ...
    internal const string CryptoStringFactoryMessage =
        "Cryptographic factory methods accepting an algorithm name are obsolete. Use the parameterless Create factory method on the algorithm type instead.";

    internal const string CryptoStringFactoryDiagId = "SYSLIB0045";

    internal const string ControlledExecutionRunMessage =
    ...
    internal const string XmlSecureResolverMessage =
    ...
    internal const string RsaEncryptDecryptValueMessage =
    ...
    internal const string RegexExtensibilityImplMessage =
    ...
    internal const string AesGcmTagConstructorMessage =
