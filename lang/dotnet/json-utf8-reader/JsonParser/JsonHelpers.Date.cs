...
internal static partial class JsonHelpers
{
    ...
    public static bool TryParseAsISO(ReadOnlySpan<byte> source, out DateTimeOffset value)
    {
        ...
        if (parseData.OffsetToken ==
            JsonConstants
                .UtcOffsetToken || // Same as specifying an offset of "+00:00", except that DateTime's Kind gets set to UTC rather than Local
    ...
    /// </summary>
    private static bool TryCreateDateTimeOffset(DateTime dateTime, ref DateTimeParseData parseData,
        out DateTimeOffset value)
    {
        ...
        long offsetTicks = (((long)parseData.OffsetHours) * 3600 + ((long)parseData.OffsetMinutes) * 60) *
    ...
    /// </summary>
    private static bool TryCreateDateTimeOffsetInterpretingDataAsLocalTime(DateTimeParseData parseData,
        out DateTimeOffset value)
    {
    ...
    private static bool TryCreateDateTime(DateTimeParseData parseData, DateTimeKind kind, out DateTime value)
    {
        ...
        Debug.Assert(parseData.Fraction >= 0 &&
                     parseData.Fraction <=
                     JsonConstants
